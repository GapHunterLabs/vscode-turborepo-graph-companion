# Privacy Policy — Turborepo Graph Companion

**Effective date:** 2026-09-07

Turborepo Graph Companion is a Gap Hunter Labs extension for Visual Studio Code. This
...
**Nothing.** Turborepo Graph Companion does not collect, store, transmit, or sell any
...
**None.** Turborepo Graph Companion makes zero network calls during normal operation.
...
None. Turborepo Graph Companion has no third-party SDKs, no analytics libraries, no
ad networks, no external dependencies that phone home. The only
runtime dependency is the `vscode` extension API itself.
